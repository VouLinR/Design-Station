...
const menuData = [
    {
        ...
        tags: ["主厨推荐", "招牌菜"],
        image: "assets/images/wagyu-truffle.jpg"
    },
    {
        id: 2,
        name: "鹅肝慕斯",
        ...
        tags: ["经典前菜"],
        image: "assets/images/foie-gras-mousse.jpg"
    },
    {
        id: 3,
        name: "龙虾浓汤",
        ...
        tags: ["海鲜"],
        image: "assets/images/lobster-bisque.jpg"
    },
    {
        id: 4,
        name: "香煎银鳕鱼",
        ...
        tags: ["海鲜", "健康"],
        image: "assets/images/seared-black-cod.jpg"
    },
    {
        id: 5,
        name: "巧克力熔岩蛋糕",
        ...
        tags: ["甜品", "经典"],
        image: "assets/images/chocolate-fondant.jpg"
    },
    {
        id: 6,
        name: "勃艮第红酒",
        ...
        tags: ["红酒", "配餐"],
        image: "assets/images/burgundy-pinot-noir.jpg"
    }
];
...
function renderMenu(category) {
    ...
    filtered.forEach(dish => {
        ...
        card.innerHTML = `
            <img class="dish-card-image" src="${dish.image}" alt="${dish.name}" loading="lazy">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const embedBg = params.get('embed');
    if (embedBg === 'wine' || embedBg === 'cream') {
        document.body.classList.add('embed-' + embedBg);
    }
    const previewPage = params.get('page');
    if (previewPage && document.getElementById(previewPage)) {
        window.setTimeout(() => showPage(previewPage), 50);
    }
});
